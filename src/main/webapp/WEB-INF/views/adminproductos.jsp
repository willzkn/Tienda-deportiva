        ...
        <%@ include file="includes/headerAdmin.jspf" %>
                      ...
                      <tr>
                        <td>
                          <c:choose>
                            ...
                            <c:otherwise>
                              <div
                                style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; background: #f0f0f0; color: #666; font-size: 12px; border-radius: 6px;">
                                Sin imagen
                              </div>
                            </c:otherwise>
                          </c:choose>
                        ...
                        <td>
                          <form action="${pageContext.request.contextPath}/admin/productos/cambiar-estado" method="post"
                            style="display:inline;">
                            <input type="hidden" name="id" value="${producto.id_producto}">
                            <input type="hidden" name="activo" value="${!producto.activo}">
                            <button type="submit" class="btn"
                              style="background-color: ${producto.activo ? '#28a745' : '#dc3545'}; color: white; border: none; padding: 5px 10px; cursor: pointer; border-radius: 4px;">
                        ...
                        <td>
                          <div class="action-buttons">
                            <a href="${pageContext.request.contextPath}/admin/productos/editar/${producto.id_producto}"
          ...
          <div id="addProductModal" class="modal" style="display: none;">
            <div class="modal-content">
              ...
              <form id="addProductForm" action="${pageContext.request.contextPath}/admin/productos/guardar"
